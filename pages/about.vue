            ...
            <div class="split_section_right_content">
              ...
              <div class="split_section_text">
                <p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse
                  ...
                  primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse nec faucibus velit.
                  Quisque eleifend orci ipsum, a bibendum lacus suscipit sit. Vestibulum ante ipsum primis in faucibus
                  orci luctus et ultrices posuere cubilia Curae; Suspendisse nec faucibus velit. Quisque eleifend orci.
                </p>
              </div>
...
export default {
  ...
  head: {
    link: [
      ...
      { rel: 'stylesheet', href: '/styles/about_responsive.css' },
    ],
    script: [
      { defer: true, src: '/js/about.js' }
    ]
  }
}
</script>
